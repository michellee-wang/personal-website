...
export function SocialLinks() {
  return (
    <div className="flex gap-6 mt-4 justify-center text-[var(--accent-color)]">
      <IconWrap href="https://github.com/michellee-wang" label="GitHub">
      ...
      <IconWrap href="https://www.linkedin.com/in/mw857/" label="LinkedIn">
        <svg {...svgProps} fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
      ...
      <IconWrap href="https://x.com/michellewang857" label="X">
        <svg {...svgProps} fill="currentColor">
          <path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-4.714-6.231-5.401 6.231H2.744l7.727-8.835L1.254 2.25H8.08l4.253 5.622L18.244 2.25zm-1.161 17.52h1.833L7.084 4.126H5.117L17.083 19.77z" />
        </svg>
      </IconWrap>
      <IconWrap href="https://instagram.com/michellee.wang" label="Instagram">
        <svg {...svgProps} fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">

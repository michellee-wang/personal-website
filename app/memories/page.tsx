...
export default function Memories() {
  ...
  useEffect(() => {
    ...
    const user = "michellewang857";
    setTimeout(() => {
      setEmail(`${user}@${domain}`);
      
      const encodedMailto = btoa(`mailto:${user}@${domain}`);
      setEncodedEmail(encodedMailto);
    }, 500);
  }, []);
  ...
  const handleEncryptedEmailClick = (e: React.MouseEvent<HTMLButtonElement>) => {
    e.preventDefault();
    if (encodedEmail) {
    ...
    <div className="flex flex-col items-center justify-center min-h-screen bg-white text-black font-krub">
      <main className="w-full max-w-5xl mx-auto p-4">
        ...
        <div className="flex flex-col sm:flex-row items-center mb-8">
          <Link href="/" className="text-[#7691cc] hover:underline mb-4 sm:mb-0">
            ← Back to home
          </Link>
        ...
        <div className="hidden sm:flex fixed left-4 top-4 flex-col gap-4 z-20">
          <a href="https://github.com/michellee-wang" target="_blank" rel="noopener noreferrer">
            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="#7691cc" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
        ...
        <div className="w-full max-w-md mx-auto my-8 px-4">
          <h3 className="text-center text-lg mb-3 font-light italic text-[#7691cc]">my fav song rn</h3>
          <iframe 
        ...
        <div className="sm:hidden flex justify-center gap-6 mt-8 mb-4">
          <a href="https://github.com/michellee-wang" target="_blank" rel="noopener noreferrer">
            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="#7691cc" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
              <path d="M9 19c-5 1.5-5-2.5-7-3m14 6v-3.87a3.37 3.37 0 0 0-.94-2.61c3.14-.35 6.44-1.54 6.44-7A5.44 5.44 0 0 0 20 4.77 5.07 5.07 0 0 0 19.91 1S18.73.65 16 2.48a13.38 13.38 0 0 0-7 0C6.27.65 5.09 1 5.09 1A5.07 5.07 0 0 0 5 4.77a5.44 5.44 0 0 0-1.5 3.78c0 5.42 3.3 6.61 6.44 7A3.37 3.37 0 0 0 9 18.13V22"></path>
            </svg>
          </a>
          <a href="https://instagram.com/michellee.wang" target="_blank" rel="noopener noreferrer">
        ...
        <div className="mt-4 sm:mt-8 text-center text-gray-600 text-sm px-4 flex flex-col items-center">
          <p>i love my friends a lot and im happiest when with them & watching them succeed. i hope one day u can be featured here</p>
